...
5. Guardar `model_runs`, predicciones y metadata.
6. Evaluar con backtesting y feedback de predicciones previas.
7. Servir la decision en la API con riesgo y trazabilidad.
